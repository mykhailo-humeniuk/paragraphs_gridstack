...
class ParagraphsGridstackFormatter extends EntityReferenceRevisionsFormatterBase implements ContainerFactoryPluginInterface {
  ...
  public function view(FieldItemListInterface $items, $langcode = NULL) {
    $entity_langcode = \Drupal::languageManager()->getCurrentLanguage(LanguageInterface::TYPE_CONTENT)->getId();
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    \Drupal::service('event_dispatcher')->dispatch(GridViewEvent::GRID_VIEW, new GridViewEvent($elements));
